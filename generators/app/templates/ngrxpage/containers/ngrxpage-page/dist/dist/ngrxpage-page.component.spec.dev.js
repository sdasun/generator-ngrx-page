...
describe('Find Stat Page', function () {
  ...
  beforeEach(function () {
    testing_1.TestBed.configureTestingModule({
      imports: [animations_1.NoopAnimationsModule, testing_2.RouterTestingModule, material_1.MaterialModule, forms_1.ReactiveFormsModule],
      declarations: [containers_1.<%= pascalName %>PageComponent, components_1.StatSearchComponent, StatPreviewComponent, StatPreviewListComponent, StatAuthorsComponent, AddCommasPipe, ellipsis_pipe_1.EllipsisPipe],
      providers: [testing_3.provideMockStore({
        selectors: [{
          selector: fromStats.selectSearchQuery,
          value: ''
        }, {
          selector: fromStats.selectSearchResults,
          value: []
        }, {
          selector: fromStats.selectSearchLoading,
          value: false
        }, {
          selector: fromStats.selectSearchError,
          value: ''
        }]
      })]
    });
  ...
  it('should dispatch a stat.Search action on search', function () {
    var $event = 'stat name';
    var action = actions_1.FindModulePageActions.listModules({
      query: $event
    });
